                ...
                <div id="text-7" class="widget widget_text realfactory-widget">
                    ...
                    <div class="textwidget">
                        <p>
                            ...
                            <br> <i class="fa fa-phone" style="font-size: 20px;color: #99c329;margin-right: 10px;"></i> +351 911 509 738 <br><span class="qts-phone-disclaimer">Chamada para a rede móvel nacional</span>
                            <br> <span class="gdlr-core-space-shortcode" style="margin-top: -6px;"></span>
